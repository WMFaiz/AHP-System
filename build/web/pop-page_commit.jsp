        ...
        <div style="margin: 10px 20px 10px 20px;" class="page-header">
            <div style="width: 100%; height: 100%;"  class="pop_pairwise">
                <div style="width: 100%; height: 100%;" class="card">
                    <h4 class="card-header">Pairwise Comparisons (Commitment)
                                ...
                                <tbody>
                                    ...
                                    <%
                                        try {
                                            ...
                                            ResultSet rs = ps.executeQuery();
                                            while (rs.next()) {
                                                String getData = "SELECT commit FROM user_criteria WHERE id=?";
                                                PreparedStatement statement = java_process.connection().prepareStatement(getData);
                                                statement.setInt(1, rs.getInt(1));
                                                ResultSet result = statement.executeQuery();
                                                if(result.next()){
                                                    out.print("<td>"
                                                            + "<input type='number' name='commit_ref' class='commit_ref' id='pw_constant' readOnly>%"
                                                            + "</td>");
                                                }
                                            }
                                            java_process.connection().close();
                ...
                <div class="pop_conclusion">
                    <div style="width: 100%; height: 100%;" class="card">
                        <div style="width:100%; height:100%;overflow:auto;" class="table-responsive">
                            ...
                            <input type="hidden" name="trust_data" class="trust_data" id="trust_data" value="0" readOnly>
                            <input type="hidden" name="commit_data" class="commit_data" id="commit_data" value="0" readOnly>
                            <input type="hidden" name="inte_data" class="inte_data" id="inte_data" value="0" readOnly>
                            <input type="hidden" name="track_data" class="track_data" id="track_data" value="0" readOnly>
                            <input type="hidden" name="exp_data" class="exp_data" id="exp_data" value="0" readOnly>
                            <input type="hidden" name="extend6_data" class="extend6_data" id="extend6_data" value="0" readOnly>
                            <input type="hidden" name="extend7_data" class="extend7_data" id="extend7_data" value="0" readOnly>
                            <input type="hidden" name="extend8_data" class="extend8_data" id="extend8_data" value="0" readOnly>
                            <input type="hidden" name="extend9_data" class="extend9_data" id="extend9_data" value="0" readOnly>
                            <input type="hidden" name="extend0_data" class="extend0_data" id="extend0_data" value="0" readOnly>
                            <input type="hidden" name="lambda_max" class="lambda_max" id="lambda_max" value="0" readOnly>
                            <input type="hidden" name="c_index" class="c_index" id="c_index" value="0" readOnly>
                            <input type="hidden" name="c_ratio" class="c_ratio" id="c_ratio" value="0" readOnly>
